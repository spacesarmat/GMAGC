...
ПК-приложение умеет искать по фото (см. выше), Android-приложение пока **каркас** с превью камеры. Сервер и подключение телефона придут следующими этапами. Приложения без подписей:
