        ...
        self.help_view = ft.Column(
            [
                ...
                ft.Text(
                    ...
                    "(сохраните текст как .xml и положите в папку fixturetypes библиотеки grandMA3). "
                    "Для grandMA2 отправляется по одному режиму: кнопка «Поделиться режим для grandMA2» на экране режима.",
                    size=13,
                ),
            ],
            spacing=8,
