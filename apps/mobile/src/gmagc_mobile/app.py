        ...
        self.help_view = ft.Column(
            [
                ...
                ft.Text(
                    ...
                    "«Поделиться профилем» в виде JSON или «Поделиться для grandMA3» готовым XML типа прибора (сохраните текст как .xml и положите в gma3_library\fixturetypes). Экспорт для grandMA2 появится позже.",
                    size=13,
                ),
            ],
            spacing=8,
