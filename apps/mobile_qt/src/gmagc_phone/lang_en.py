...
EN = {
    ...
    "Автосканирование недоступно на этом телефоне. Наведите камеру на QR-код в приложении на ПК (приближение и касание для фокуса помогают) и нажмите «Считать QR»": "Automatic scanning is not available on this phone. Point the camera at the QR code in the PC app (zoom and tapping to focus help) and tap “Scan QR”",
    ...
    "Камера доступна только на телефоне (Android): здесь можно выбрать фото из галереи": "The camera is available only on a phone (Android): here you can choose a photo from the gallery",
    ...
    "Автоматическое чтение QR недоступно на этом телефоне: введите адрес и код вручную.": "Automatic QR reading is not available on this phone: enter the address and code manually.",
    "Чтение QR недоступно на этом телефоне: введите адрес и код вручную.": "QR reading is not available on this phone: enter the address and code manually.",
    "Снимок камеры не удалось прочитать ({error}). Введите адрес и код вручную.": "Could not read the camera shot ({error}). Enter the address and code manually.",
    "Ошибка камеры: {error}": "Camera error: {error}",
    "QR-код не найден. Поднесите камеру ближе (приближение и касание для фокуса помогают): код должен быть целиком в кадре и чётким. Если не выходит, введите адрес и код вручную.": "QR code not found. Bring the camera closer (zoom and tapping to focus help): the code must be fully in the frame and sharp. If it does not work, enter the address and code manually.",
